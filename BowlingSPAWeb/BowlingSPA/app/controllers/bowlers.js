...
(function (BowlingSPA) {
    (function (Controllers) {
        ...
        var BowlersController = (function () {
            function BowlersController($scope, $http, bowling) {
                var _this = this;
                ...
                $scope.getBowlersLeagues = function ($item) {
                    ...
                    bowling.getBowlerLeagues($item.Id).then(onGetBowlersLeagues, onGetBowlersLeaguesError);
                };
                ...
                $scope.showBowlerData = function ($event, bowlerId, teamId) {
                    ...
                    bowling.getBowlerStandings(bowlerId, teamId).then(onBowlerStandings, onBowlerStandingsError);
                    //$scope.userName = "Split Happens";
                };
            }
            BowlersController.$inject = ["$scope", "$http", "bowling"];
